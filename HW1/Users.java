...
public abstract class Users implements SystemInterface {
    ...
    public abstract void addBook (Books newBook,ArrayList<Books>booksList,String filename);
    ...
    public abstract void removeBook (Books books,ArrayList<Books>booksList,String filename);
    ...
    public boolean isAvailable(String bookID,ArrayList<Books>booksList){
