...
public class SingleLinkedList<E> implements Iterable<E>{
     ...
     * @return Verilen indeksteki node'u alir ve o node'un datasini dondurur.
     */
    ...
    /**
     * Bu method SingleLinkedList'deki elemanları sondan basa dogru stringe recursive olarak ekler.
     * @param strBuild - StringBuilder
     * @param index - Dizide bulunan son elemanin indeks degeri
     * @return LinkedList'deki elemanlari sondan basa dogru stringe cevirir
     */

    private String helperRecursive(StringBuilder strBuild,int index){
        if (index < 0){
            return strBuild.toString();
        }
        strBuild.append(get(index));
        strBuild.append(" ");
        return helperRecursive(strBuild,index-1); //Recursive call
    }

    /**
     * Bu method, kendisinin yardimci methodu olan helperRecursive methodunu cagirir.
     * @return SingleLinkedList'de bulunan elemanlari ters bir sekilde stringe cevirir.
     */

    public String toReverseString(){
        StringBuilder stringBuild = new StringBuilder();
        return helperRecursive(stringBuild, getSize()-1);
    }
